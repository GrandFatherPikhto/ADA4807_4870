...
7. **Файлы** — пути ко всем сопутствующим артефактам (CSV, лог LTspice,
   ...
   пересылается отдельно от остальной папки `out/`.
...
![Напряжение сигнала/Ток](out/time_domain.png)
...
![Спектр сигнала](out/spectrum.png)
